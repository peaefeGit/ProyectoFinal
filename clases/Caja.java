...
public class Caja {
    private Double montoApertura;// falta implementar constructor y demas..
    private ArrayList<String> egreso;//
    private ArrayList<String> movimiento;// "+"descripcionDeposito ** "-"descripcionExtraccion
